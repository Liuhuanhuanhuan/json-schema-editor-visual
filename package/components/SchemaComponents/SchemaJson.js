...
class SchemaArray extends PureComponent {
  ...
  // 判断父节点是否有禁止属性
  handleDisableEdit = (data, prefixArray) => {
  ...
  render() {
    ...
    const value = items.disableEdit
    // 禁止编辑
    let disabled = _.isUndefined(value)
          ...
          >
            ...
            >
              <Row type="flex" justify="space-around" align="middle">
                ...
                <Col span={22}>
                  <Input
                    addonAfter={<Checkbox disabled={true} />}
                    disabled={true}
                    value="Items"
                  />
                </Col>
              ...
              <Input
                ...
                addonAfter={
                  <EditOutlined
                    type="edit"
                    onClick={
                      disabled ? () => {} : () => this.handleShowEdit('title')
                    }
                  />
                }
                ...
                addonAfter={
                  <EditOutlined
                    ...
                    onClick={
                      disabled
                        ? () => {}
                        : () => this.handleShowEdit('description')
                    }
                  />
                }
